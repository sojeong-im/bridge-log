...
function App() {
  ...
  const [activities, setActivities] = useState([
    ...
    { id: 2, title: '시험 끝! 성수동 카페 번개', location: '성수동', image: '/seongsu.jpg', description: '전공 시험 다들 고생 많았어요! 수다는 역시 힐링..', participants: ['미뉴', '아르몽', '작가님'] },
    ...
    { id: 5, title: '시험기간 현장 실시간 🔥', date: '2026.04.10', location: '중앙대학교', image: '/exam_period.jpg', description: '다들 지쳐 쓰러졌네요 ㅠㅠ 그래도 조금만 더 힘냅시다! 중간고사 화이팅!', participants: ['로보', '유진스', '건축왕', '미뉴'] },
    { id: 6, title: '🍰 브릿지표 가성비 케이크', location: '스터디룸', image: '/cake.jpg', description: '카페 케이크가 비싸서 직접 만든 초코파이+오레오 케이크! 퀄리티 대박이죠? 가성비 당 충전 완료 😋', participants: ['미뉴', '유진스', '작가님'] },
  ]);
